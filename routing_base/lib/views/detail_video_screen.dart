...
import 'package:api_base/views/second_detail_video_screen.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: (){
              var route = MaterialPageRoute(builder: (context) => SecondDetailVideoScreen(videoModel: videoModel,));
